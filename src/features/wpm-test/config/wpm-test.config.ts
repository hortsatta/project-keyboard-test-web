...
export const timeSecondAmountList = [15, 30, 60, 90];

export const wordAmountList = [25, 50, 100, 200];

export const DEFAULT_TEST_SYSTEM_OPTIONS = {
  recordAudioWhenPlaying: false,
...
export const DEFAULT_AUDIO_RECORDING = {
  hasError: false,
  blob: undefined,
};
